...
export default function UpdatePlayer({ data: playersData }: any) {
  ...
  const form = useForm<z.infer<typeof FormSchema>>({
    ...
    defaultValues: {
      player_name: playersData.player_name,
      player_surname: playersData.player_surname,
      player_middle_name: playersData.player_middle_name,
      player_nickname: playersData.player_nickname,
      player_image: playersData.player_image,
      player_gender: playersData.player_gender,
      player_title: playersData.player_title,
      player_residence: playersData.player_residence,
      player_title_date: new Date(playersData.player_title_date),
      player_join_date: new Date(playersData.player_join_date),
      player_district: playersData.player_district,
      player_mobile_number: playersData.player_mobile_number,
      player_mail: playersData.player_mail,
      player_socials: playersData.player_socials,
    },
  });
